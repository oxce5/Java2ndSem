...
public class Main {
  private static final int[] arr1 =
  {
    ...
    979,818,462,991,634,154,49,296,924,255,759,653,535,894,520,206,100,8,218,811,129,215
    ,782,125,13,319,601,573,559,408,685,360,626,331,489,335,797,153,937,489,942,5,415,47,
  ...
  private void replaceAllInstances(int[] array, int target, int replace) {
    for (int i = 0; i < array.length; i++) {
      if (array[i] == target) {
        array[i] = replace;
        System.out.printf("%d at index %d replaced with %d.%n", target, i, 402);
        System.out.printf("Verify: Index %d is %d", i, array[i]);
      }
    }
  }
  ...
  public static void main(String[] args) {
    ...
    for (int i : arr3) {
      if (i == 80) System.out.println(i);
    }

    System.out.println("\nACTIVITY 2");
    main.findAllInstances(arr1, 984);
    System.out.println("\nACTIVITY 3");
